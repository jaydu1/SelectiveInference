  ...
  tabPanel('Ordered structure',
      sidebarLayout(position = 'left',
           ...
           sidebarPanel(
             ...
             sliderInput("f_param3_f2", "f_param3", min = 0.0, max = 1.0, value = 0.5, step=0.05), 
             sliderInput("f_param4_f2", "f_param4", min = 0.0, max = 1.0, value = 0.5, step=0.05),
 ...
 tabPanel('Group structure',
     sidebarLayout(position = 'left',
          ...
          sidebarPanel(
            ...
            numericInput("f_param1_f3", "f_param1", value=2), 
            numericInput("f_param2_f3", "f_param2", value=2), 
            sliderInput("f_param3_f3", "f_param3", min = 0.0, max = 1.0, value = 0.5, step=0.05), 
            sliderInput("f_param4_f3", "f_param4", min = 0.0, max = 1.0, value = 0.5, step=0.05),
